...
Experimental, dependency-free execution relay for delegating bounded Codex tasks to compatible third-party model Providers. Relay version 0.10.27.
...
```bash
python3.11 scripts/operational_report.py --days 7 --relay-version 0.10.27 \
